...
bayesmark-launch -dir $DB_ROOT -b $DBID -n $N_STEP -r $N_REPEAT -p $N_BATCH -o $OPT turbo hyperopt skopt random-search opentuner --opt-root $OPT_ROOT -v -c MLP-adam -d diabetes
